# Pixel Plus Hackathon 2025 - Submission Details

## Project: Spotify Clone with Audius API Integration and Interactive Audio Visualizer

### Live Demo
**URL:** [https://bdnzesde.manus.space](https://bdnzesde.manus.space)
...
4. **Use the Visualizer:**
   - Click the visualizer button in the player controls (speaker icon)
